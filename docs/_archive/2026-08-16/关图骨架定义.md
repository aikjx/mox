...
| P3 | 六维绑定 Registry（R06）+ TraceMatrix；数据表挂接 crate（R07/R08） | 六维零孤儿、连通 REQ ✅（已认证：primiflow-fusion 44 测 + 全 workspace 644 测 0 错 0 败；`platform::p3_exit_gate_zero_orphan_connected_to_req` 直接编码出口闸） |
