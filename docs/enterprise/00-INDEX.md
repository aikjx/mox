...
> | 测试基线 | workspace 全绿（实测 2026-08-18 `cargo test --workspace --no-fail-fast`：**644 passed / 0 failed / 6 ignored**，58 测试二进制）：xuanji-expert 146、primiflow-fusion 44、runtime 33（另 5 项 E2E 集成实测通过）、primiflow 53 等，详见 `09` §3 与验收报告 §6 |
>
