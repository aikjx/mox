# 企业级规范术语表 (GLOSSARY · DOC-GLOSSARY-V1.3 · 三联盟统一版)
...
> **版本**：DOC-GLOSSARY-V1.3 · 2026-08-23
> **主责联盟**：三联盟联合（产品=业务与产品名 · 算法=图谱/算法术语 · 开发=工程/路径术语）
...
> **新增 v1.3 2 大术语（对齐 22 全文档归一化总控卡 = 归一化治理最高法院法典）**：**全文档归一化总控卡（DOC-NORMALIZATION-MASTER 22 号）** · **Aura SRS 全要点落地清单（4 栏打钩 100% 闭环 = 对外 SRS 归一化完成证书）**。

---

## 1. 系统与架构主体（DOC-GLOSSARY-V1.3 · 扩展为 19 项：v1.1 14 项 + v1.2 新增 3 项 + v1.3 新增 2 项归一化治理术语）
