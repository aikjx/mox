...
*相关文档：[微服务架构设计](docs/architecture/microservices/README.md) | [服务边界优化](docs/architecture/microservices/01-service-boundaries.md) | [通信架构优化](docs/architecture/microservices/02-communication.md)*
