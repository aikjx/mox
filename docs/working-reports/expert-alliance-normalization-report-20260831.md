...
| 26 | `docs/modules/专家联盟-MOX业务流程归一化手册-V1.0.md` | P0-4路径修正+术语 | 9处代码路径修正（mox-expert→alliance域）+ 覆盖范围更新（18+→47份）+ doc_id（EA-DOC-066） | B组 |
...
| # | 文件路径 | 修改类型 | 修改内容摘要 | 执行组 |
|---|---------|---------|-------------|--------|
| 48 | `docs/modules/专家联盟-MOX业务流程归一化手册-V1.0.md` | 引用修复 | 6处`../`→仓根相对路径 + 1处`./`→仓根相对路径 | 最终阶段 |
...
| 2 | 28号报告元信息 | `docs/enterprise/28-MOX分析与文档归一化报告-V1.0.md`已有🟡参考声明，但未补充完整元信息块和doc_id | 1周内 |
...
| 8 | 重复文档合并评估 | 评估R7组（mox-expert三视图）是否需要合并为一份"mox-expertMOX设计书" | P2 |
