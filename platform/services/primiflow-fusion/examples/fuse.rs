...
use primiflow_fusion::registry::CRATE_NAMES;
use primiflow_fusion::{fuse_all, PlatformReport, PrimiPlatform, UnifiedGraph};
...
fn main() {
    ...
    println!(
        ...
        primiflow_fusion::unified::GLOBAL_CONSERVATION_EPS,
