...
use mox_t21_harness::fusion::tag_parser::Tag;
use mox_t21_harness::fusion::graph_writer::GraphWriter;
...
#[test] fn a3_stats_11_tag_id_roundtrip_decode() {
    use mox_t21_harness::fusion::graph_writer::{tag_id_of, tag_id_decode};
...
#[test] fn a3_stats_15_uri_obj_id_deterministic() {
    use mox_t21_harness::fusion::graph_writer::obj_id_of;
