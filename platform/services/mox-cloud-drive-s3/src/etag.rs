//! ETag 生成工具：小对象直接 MD5 + CRC32C；大对象复用 mox-standards。
//!
//! S3 约定：
...
use mox_standards::etag_crc32c::{crc32c_base64, crc32c_checksum, etag_multipart};
...
/// 复用 mox-standards 的 MPU 最终 ETag（含引号）。
