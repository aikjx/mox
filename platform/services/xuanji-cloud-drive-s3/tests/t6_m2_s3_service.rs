...
use xuanji_cloud_drive_s3::S3Server;
use xuanji_standards::etag_crc32c::{crc32c_base64, crc32c_checksum, etag_multipart};
use xuanji_standards::sigv4::sigv4_auth_header;
...
const TEST_AK: &str = "AKIAXUANJITEST00001";
const TEST_SK: &str = "xuanji-secret-key-test-suite-v1-2026";
...
async fn start_server() -> String {
    for _ in 0..200 {
        ...
        srv.register_credential(TEST_AK, TEST_SK, "xuanji-user");
...
async fn tr68_mpu_giant_case_1() {
    ...
    for pn in 1..=n_parts {
        let p = format!("P{pn:04}-xuanji-s3-XXXXXXXX-XXXX").into_bytes();
