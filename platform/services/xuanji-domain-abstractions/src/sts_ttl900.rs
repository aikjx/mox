...
//!
//! SM2 双签名逻辑位于独立的 xuanji-standards crate 中（`gm-sm` feature），
...
///
/// SM2 双签名能力见 `xuanji-standards` crate 中 `StsServiceSm2` 封装，
...
impl StsService {
    ...
    /// 完整的双签名验证请使用上层封装（`xuanji-standards` 的 `StsServiceSm2`），
...
// ===========================================================================
// Tests  (基础 HMAC；A1-A4 gm-sm 测试位于 xuanji-standards crate)
// ===========================================================================
