...
//!
//! Covers:
//! - XuanjiMetrics builds successfully; all 10 base names appear in exposition.
...
use rand::Rng;
use xuanji_server::{
    BenchSamples, XuanjiMetrics, interpolated_percentile, METRIC_BASE_NAMES,
};

// T9-01: XuanjiMetrics::new + encode_text contains all 10 base names.
#[test]
