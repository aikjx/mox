...
// metrics counters (xuanji_ec_encode_us / rebuild / shards_lost).  Without
...
// ---------------------------------------------------------------------------
// T2-TR12 — xuanji_ec_encode_us histogram (Vec samples + atomic counter).
// ---------------------------------------------------------------------------
#[test]
...
// ---------------------------------------------------------------------------
// T2-TR15 — Rebuild counter (xuanji_ec_rebuild_count) increments on run().
// ---------------------------------------------------------------------------
#[test]
