...
use primiflow_fusion::{EntityKind, UnifiedGraph};
...
/// 三重闸门 DTO（`primiflow_fusion::PlatformGate` 的可序列化投影）
#[derive(Debug, Clone, Serialize, Deserialize)]
...
mod tests {
    use super::*;
    use primiflow_fusion::{PrimitiveCoords, RelKind, UnifiedEdge, UnifiedNode};
