...
fn tr8_9_atlas_verify_m3() {
    ...
    assert_eq!(crate_id, "xuanji-cloud-drive-filer");
    let three_registries = [
        "crate:xuanji-cloud-drive-filer",
        "service:m3_posix_filer",
        "platform:xuanji_cloud",
    ];
    ...
    let ok = crate_id == "xuanji-cloud-drive-filer" && pjd == PJD_CASES_TOTAL && meta_backends_3;
