...
pub mod posix_skeleton {
    ...
    use mox_domain_abstractions::{FileStat, MetaStorageProvider, MockMetaStorageProvider};
    #[async_trait]
...
pub mod ngql_skeleton {
    use async_trait::async_trait;
    use mox_domain_abstractions::{GraphQueryProvider, MockGraphQueryProvider, QueryResultSet};
    #[async_trait]
...
pub mod ais_skeleton {
    use async_trait::async_trait;
    use bytes::Bytes;
    use mox_domain_abstractions::{MockGraphMetaProvider, MockIamProvider, MockObjectStorageProvider};
