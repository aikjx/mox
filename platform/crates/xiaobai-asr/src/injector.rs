...
use xiaobai_core::hotword::{apply_fuzzy, validate_and_rank, Hotword};
...
impl HotwordInjector {
    ...
    pub fn set_hotwords(&self, raw: &[Hotword]) -> Result<(Vec<Hotword>, InjectionReport), xiaobai_core::errors::XiaobaiError> {
    ...
    pub fn apply_post_hoc(&self, asr_text: &str) -> Result<(String, Vec<Hotword>), xiaobai_core::errors::XiaobaiError> {
