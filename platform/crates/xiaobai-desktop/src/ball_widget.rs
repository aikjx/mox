...
impl DesktopApp {
    ...
    pub fn spawn_voice_server_background(&mut self) -> Result<String, Box<dyn std::error::Error>> {
        use xiaobai_operators::server_3717::{run_service_blocking, VoiceServiceConfig};
    ...
    pub async fn dispatch_local_text(&self, text: &str) -> Result<serde_json::Value, xiaobai_core::errors::XiaobaiError> {
        use xiaobai_operators::server_3717::{VoiceServiceConfig, XiaobaiVoiceService};
        let cfg = VoiceServiceConfig::default();
