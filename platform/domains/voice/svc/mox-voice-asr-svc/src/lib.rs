...
//! - validate_and_rank()：复用 mox_voice_core_svc::hotword::validate_and_rank（已实现 Levenshtein 去重、max_score 饱和、max_length 检查、黑名单 PII 警告）
...
//! - apply_post_hoc(S3)：调 mox_voice_core_svc::hotword::apply_fuzzy 替换 + 命中热词 Vec
//!
