...
use mox_ai_flow_svc::pipeline::{optimize, OptimizeConfig};
use mox_ai_flow_svc::OptimizationReport;
use rayon::prelude::*;
...
fn prefix_deep_chain_subgraph_inner(total: usize, subgraph_id: &str) -> FlowGraph {
    use mox_ai_flow_svc::model::{Access, AccessMode, FlowEdge, FlowNode, NodeKind, ToolKind};
