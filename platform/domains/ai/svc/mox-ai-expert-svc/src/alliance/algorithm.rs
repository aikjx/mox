...
use crate::types::{AlgoCheckItem, AlgorithmAnalysisRequest, AlgorithmAnalysisResponse};
...
mod tests {
    ...
    use crate::types::AlgorithmAnalysisRequest;
    ...
    fn test_analysis_all_dimensions() {
        ...
        assert!(result.latency_ms < 1000); // 应快速返回
    }
    ...
    fn test_analysis_complexity() {
        ...
        assert_eq!(result.checks.len(), 3); // 3 项复杂度检查
    }
