...
use axum::Router;
use mox_platform_orchestrator_svc::handlers::ai_engine::{AiEngineState, ProcessOptions, ProcessRequest};
use mox_platform_orchestrator_svc::sidecar::node_sidecar::NodeSidecarClient;
...
fn build_router() -> Router {
    ...
    mox_platform_orchestrator_svc::routes::ai_engine::ai_engine_routes(Arc::new(state))
}
