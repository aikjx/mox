...
use sea_query::{
    Alias, ColumnDef, Iden, MysqlQueryBuilder, PostgresQueryBuilder, SqliteQueryBuilder, Table,
};
    ...
    ($b:expr) => {
        vec![
            ...
            Table::create()
                ...
                .col(ColumnDef::new(Members::MoxId).string().not_null())
            ...
            Table::create()
                ...
                .col(ColumnDef::new(Tasks::MoxId).string().not_null())
            ...
            Table::create()
                ...
                .col(ColumnDef::new(Channels::MoxId).string().not_null())
            ...
            Table::create()
                ...
                .if_not_exists()
                .col(
                    ColumnDef::new(Bindings::MemberId)
                        .string()
                        .not_null()
                        .primary_key(),
                )
