...
NEWS = [
    (1, "墨行科技发布新一代AI企业平台，低代码+知识图谱双引擎上线", "产品发布", "2026-08-20",
     ...
     "<p>墨行科技正式发布新一代AI企业平台MX-Cloud 3.0，深度融合动态SQL引擎与自研知识图谱，实现企业数据操作mox 模块化系统架构维度可配置。</p><p>平台内置DSQL引擎将所有业务SQL纳入数据库管理，支持模板渲染、参数校验、多级缓存与版本回滚；自研知识图谱让实体关系可视化，支持多跳关联查询。</p>"),
