...
> 对应 spec：`.trae/specs/20260823-xuanji-storage-distributed-ai-unified-query/spec.md`
...
- **Depends On**: T8
- **Description**:
  - 新建 `sdk/xuanji-sdk-node/`、`sdk/xuanji-sdk-py/`、`sdk/xuanji-sdk-rs/`；
...
- **Description**:
  ...
  - 输出 08-企业级交付清单风格的验收矩阵（Markdown 报告，写入 `docs/enterprise/18-xuanji-storage-ai-unified-query-report.md`）。
