...
export const createExpertSession = (payload) => http.post('/expert-sessions', payload)
export const listExpertSessions = () => http.get('/expert-sessions')
export const getExpertSession = (id) => http.get(`/expert-sessions/${encodeURIComponent(id)}`)
export const sendSessionMessage = (id, payload) => http.post(`/expert-sessions/${encodeURIComponent(id)}/message`, payload)
export const createExpertChain = (payload) => http.post('/expert-chains', payload)
export const listExpertChains = () => http.get('/expert-chains')
export const executeExpertChain = (id, payload) => http.post(`/expert-chains/${encodeURIComponent(id)}/execute`, payload)
