...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem #'transparent = ##t
     \time 4/4 \mark \markup{1=B\flat} \tempo 4=85  \note-mod "1" c'4  \note-mod "2" d'4  \note-mod "3" e'4  \note-mod "4" f'4 | %{ bar 2: %}
 \note-mod "5" g'4
 \note-mod "6" a'4  \note-mod "7" b'4  \note-mod "1" c''4^. | %{ bar 3: %}
 \note-mod "7" b'4
 \note-mod "6" a'4  \note-mod "5" g'4  \note-mod "4" f'4 | %{ bar 4: %}
...
\new Lyrics = "IX" { \lyricsto "W" { do re mi fa sol la ti do } } 
>>
\layout{
  \context {
    \Global
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="Y" { \time 4/4 \transpose c bes, { \key c \major  \tempo 4=85 c'4 d'4 e'4 f'4 | %{ bar 2: %} g'4 a'4 b'4 c''4 | %{ bar 3: %} b'4 a'4 g'4 f'4 | %{ bar 4: %} e'4 d'4 c'2 } } }
% === END MIDI STAFF ===
