...
| 6 | `expert-alliance` | L7 治理合规 | （见融合统一图 crate:expert-alliance 节点）|
| 7 | `hermes-flow-bridge` | L5 执行运行时 | （见融合统一图 crate:hermes-flow-bridge 节点）|
...
| 12 | `alliance-system` | L7 治理合规 | （见融合统一图 crate:alliance-system 节点）|
