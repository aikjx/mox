# Mox 3.0.0 HA 拓扑 / 容量规划 / 3 年 TCO 白皮书

**文档版本：** 1.0
**发布日期：** 2026-08-24
**适用：** Mox Graph Platform Production Gold SLA
...
| 软件 | Mox 3.0 Platform 订阅 (年度 License) | 360,000 | OPEX |
...
| 软件 | Mox 3.x Platform 年度 License (含小版本升级) | 432,000 | OPEX |
...
| 软件 | 国产数据库 + Mox 4.0 升级一次性费用 + 年度订阅 | 600,000 | OPEX |
